...
namespace CoVid.Models
{
    public class GeoZone : IComparable
    {
        ...
        public List<GeoZone> sonList {get;set;}
        public string geoID {get;set;}
        public string code {get;set;}
        public string name {get;set;}
        public int population {get;set;}
        public List<CoVidData> dataList {get;set;}
        ...
        public GeoZone(GeoZone pGeoZone, bool copyDataList = true)
        {
            ...
            if(pGeoZone.sonList != null)
                this.sonList = new List<GeoZone>(pGeoZone.sonList);
            ...
            if(copyDataList)
                this.dataList = new List<CoVidData>(pGeoZone.dataList);
        }
