...
1. Iniciar aplicación [DataAccess_API](../../DataAccess_API/ManualSimpleUsuario_DataAccess_API.md).

2. Iniciar aplicación [Security_API](../../Security_API/ManualSimpleUsuario_Security_API.md).
